		                        ...
		                        <div class="row">
		                        	...
		                        	<div class="col-md-6">
										<div class="form-group">
						                  	...
						                  	<select class="form-control select2" name="codtipoagenda" id="codtipoagenda" style="width: 100%;">
					...
					$('#calendar').fullCalendar({
						...
						eventClick: function(info) {
							...
							$.get(url+"agenda/modificar/"+info.event.id,function(data){
					            ...
					            $("#codtipoagenda option[value="+evento[0]["codtipoagenda"]+"]").attr("selected",true);
