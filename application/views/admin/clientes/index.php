...
<html lang="en">
	<head>
	    ...
	    <title>Clientes | Admin SkyNet</title>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
	    ...
	    <script type="text/javascript">
			var campos = ["ruc","razonsocial","email","telefono","celular","usuario","clave"];
			var datos = ["codcliente","codperfil","ruc","razonsocial","email","telefono","celular","usuario","clave"];
		</script>

		<script src="<?php echo base_url();?>public/js/clientes.js" type="text/javascript"></script>
	</body>
</html>