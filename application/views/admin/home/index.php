		    ...
		    <div class="content-wrapper">
		        <!-- <section class="content">
		          	<div class="container-fluid">
		          		<div align="center"> <br>
							<h1><b><?php echo $info[0]['institucion'];?></b></h1> <hr>
							<img src="<?php echo base_url();?>/public/images/portada.png" height="320">
							<h4><b><?php echo $info[0]['oficina'];?></b></h4> <hr>
							<h3><center><b><?php echo $info[0]['direccion'];?> - <?php echo $info[0]['lugar'];?></b></center></h3>
						</div>
		          	</div>
		        </section> -->
		        <section class="content">
